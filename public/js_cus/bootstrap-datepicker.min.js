...
!function(a) {
    ...
    k.prototype = {
        ...
        update: function() {
            ...
            d ? (this.setValue(),
            this.element.change()) : this.dates.length && ("string" == typeof this.o.format ? (String(this.element[0].value).length === String(this.o.format).length && String(b) !== String(this.dates) && this._trigger("changeDate"),
        ...
        fillMonths: function() {
            for (var a, b = this._utc_to_local(this.viewDate), c = "", d = 0; 12 > d; d++)
        ...
        click: function(b) {
            ...
            this.o.updateViewDate && this._trigger("changeYear", this.viewDate)),
            this.o.updateViewDate && this._trigger("changeMonth", this.viewDate)),
