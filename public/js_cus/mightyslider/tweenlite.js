...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    var t = /(\d|\.)+/g
      ...
      , r = function(r) {
        ...
        if ("#" === r.charAt(0))
            return 4 === r.length && (r = "#" + r.charAt(1) + r.charAt(1) + r.charAt(2) + r.charAt(2) + r.charAt(3) + r.charAt(3)),
    ...
    _gsScope._gsDefine.plugin({
        ...
        init: function(t, e) {
            ...
            for (i in e)
                ...
                s = r(a.f ? t[i.indexOf("set") || "function" != typeof t["get" + i.substr(3)] ? i : "get" + i.substr(3)]() : t[i]),
                a.s = Number(s[0]),
                a.c = Number(n[0]) - a.s,
                a.gs = Number(s[1]),
                a.gc = Number(n[1]) - a.gs,
                a.bs = Number(s[2]),
                a.bc = Number(n[2]) - a.bs,
                (a.rgba = s.length > 3 || n.length > 3) && (a.as = 4 > s.length ? 1 : Number(s[3]),
                a.ac = (4 > n.length ? 1 : Number(n[3])) - a.as),
                a._next && (a._next._prev = a));
            return !0
        },
        set: function(t) {
            for (var e, i = this._firstPT; i; )
                e = this.numFormat ? i.s + t * i.c << 16 | i.gs + t * i.gc << 8 | i.bs + t * i.bc : (i.rgba ? "rgba(" : "rgb(") + (i.s + t * i.c >> 0) + ", " + (i.gs + t * i.gc >> 0) + ", " + (i.bs + t * i.bc >> 0) + (i.rgba ? ", " + (i.as + t * i.ac) : "") + ")",
                i.f ? this._target[i.p](e) : this._target[i.p] = e,
                i = i._next
        }
    })
}),
      ...
      , e = _gsScope._gsDefine.plugin({
        ...
        init: function(e, i, r) {
            ...
            void 0 === i.value)
                ...
                !0;
            for (this._delimiter = i.delimiter || "",
            ...
            this._text = s),
            "string" == typeof i.newClass && (this._newClass = i.newClass,
            this._hasClass = !0),
            "string" == typeof i.oldClass && (this._oldClass = i.oldClass,
            this._hasClass = !0),
        ...
        set: function(t) {
            ...
            var e, i, r, s = this._text.length, n = 0 | t * s + .5;
            this._hasClass ? (e = this._newClass && 0 !== n,
            i = this._oldClass && n !== s,
            r = (e ? "<span class='" + this._newClass + "'>" : "") + this._text.slice(0, n).join(this._delimiter) + (e ? "</span>" : "") + (i ? "<span class='" + this._oldClass + "'>" : "") + this._delimiter + this._original.slice(n).join(this._delimiter) + (i ? "</span>" : "")) : r = this._text.slice(0, n).join(this._delimiter) + this._delimiter + this._original.slice(n).join(this._delimiter),
    ...
    var a = function(b) {
      ...
      , g = window._gsDefine.plugin({
        ...
        set: function(a) {
            ...
            a = 0 === d ? 0 : this._revealDelay > d ? 1e-6 : d === this._tween._duration ? 1 : this._tween._ease.getRatio((d - this._revealDelay) / (this._tween._duration - this._revealDelay))),
            0 > a ? a = 0 : a > 1 && (a = 1),
            f = 0 | a * b + .5,
            g = this._text.slice(0, f).join(c),
            h = this._original.slice(f).join(c),
            a && ((e > this._speed || -this._speed > e) && (this._setIndex = (this._setIndex + (0 | 19 * Math.random())) % 20,
            ...
            this._target.innerHTML = "&nbsp;" === this._fillChar && -1 !== k.indexOf("  ") ? k.split("  ").join("&nbsp;&nbsp;") : k
        }
    })
      , h = g.prototype;
...
!function(a) {
    ...
    var b = a.GreenSockGlobals || a
      ...
      , v = d.SplitText = b.SplitText = function(b, c) {
        ...
        return (this.elements = j(b) ? k(b) : [b],
        this.chars = [],
        this.words = [],
        this.lines = [],
        this._originals = [],
